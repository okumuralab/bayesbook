...
logoddsratio = log(odds(1e7, 12, 6) / odds(1e7, 5, 12))
hist(logoddsratio, breaks=seq(-3,8,0.1), freq=FALSE, xlim=c(-2,6),
     col=gray(0.9), main="", xlab="log odds ratio", ylab="")
curve(dnorm(x, mean(logoddsratio), sd(logoddsratio)), add=TRUE)
